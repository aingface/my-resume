      ...
      <div className="row">
        ...
        <div className="row-right">
          <div className="project">
            ...
            <p>
              식물 관련 자체 생산 블로그 컨텐츠 글을 앱에서 카테고리 별로 보여줄 수 있도록 개편
              작업을 했습니다. 그 결과 자체 블로그 컨텐츠를 관심사에 따라 한눈에 볼 수 있도록
              바꾸었습니다.
            </p>
          ...
          <div className="project">
            ...
            <p>
              ...
              장을 만들게 되었습니다. 자신의 식물을 자랑거나 질문, 고민을 함께 이야기해볼 수 있게
              되어 앱에 큰 변화를 일으켰습니다.
            </p>
            <h5 className="DetailTitle">내가 한 일</h5>
            <ul>
          ...
          <div className="project">
            ...
            <p>
              ...
              과정에서 몇가지 과정을 생략할 수 있도록 개선 작업에 참여했습니다. 그 결과 사용자의
              식물 등록률이 80%대로 상승하게 되었습니다.
            </p>
            <h5 className="DetailTitle">내가 한 일</h5>
            <ul>
              <li>닉네임 자동 생성 개발</li>
